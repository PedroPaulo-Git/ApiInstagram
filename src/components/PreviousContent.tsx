      ...
      try {
        ...
        try {
          ...
          if (followersData.data?.items?.length) {
            ...
            setFollowersError(null); // Reseta erro caso a API funcione
          } else {
        ...
        try {
          ...
          if (highlightsData.data?.items?.length) {
            ...
            const fetchThumbnail = await fetch(
              `https://instagram-scraper-stable-api.p.rapidapi.com/get_highlights_stories.php?highlight_id=${firstHighlight.id}`,
              {
                method: "GET",
                headers: {
                  "x-rapidapi-key": "e9b32b11efmsh61c3992491c9be9p1319a0jsn3179f3d855a3",
            ...
            if (thumbnailData.items?.length) {
              ...
              setHighlightsError(null); // Reseta erro caso a API funcione
            } else {
              setHighlightsError("Nenhum destaque encontrado.");
            }
          } else {
 ...
 <LoadingSpinner/>
          ...
          <div className="relative w-full max-w-md overflow-hidden ">
            ...
            {loading ? (
              ...
              <>
                <h1 className="text-2xl mt-[50px] text-center">
                  Detectamos{" "}
                  <b className="text-[#5468FF]">conversas pessoais</b> dessa
                  pessoa
                </h1>
                <p className="text-gray-400 text-center mt-5 mb-5">
                  Nossa inteligência artificial identificou algumas conversas
                  mais pessoais.
                </p>
            ...
            <h3 className="text-2xl mt-[100px] mb-3 text-center">
              Escute agora o <b className="text-[#5468FF]">áudio</b> que a
              pessoa que você quer espionar recebeu:
            </h3>
              ...
              >
                <div className="flex gap-4 relative ">
                  ...
                  <Image
                    ...
                    className="rounded-xl w-[220px] h-[320px]"
                  />
                  <div className="flex items-center -mr-3 absolute right-11 mt-3">
                    <Image
                      src={firstUser.profile_pic_url} // Exibe a primeira thumbnail corretamente
                      alt="user highlight"
                      width={100}
